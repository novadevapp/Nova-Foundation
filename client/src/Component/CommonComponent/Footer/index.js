...
export default () => {
  return (
    <div className='footer'>
      <a href='https://www.facebook.com/novafoundationuk' target='blank'>
        <svg
      ...
      <a href='https://twitter.com/NovaFoundation_' target='blank'>
        <svg
          xmlns='http://www.w3.org/2000/svg'
          width='46'
          height='46'
      ...
      <a href='https://www.instagram.com/novafoundation/' target='blank'>
        <svg
          xmlns='http://www.w3.org/2000/svg'
          width='46'
          height='46'
