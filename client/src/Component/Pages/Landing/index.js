        ...
        <main className="land">
          <div className="land__home">
            ...
            <div className="land__links">
              <Button className="register__button" name="About Us" onClick={this.handleLinks('/about-us')}/>
              <Button className="register__button" name="Register" onClick={this.handleLinks('register')}/>
              <Button className="register__button" name="Login" onClick={this.handleLinks('/login')}/>
            </div>
          </div>
